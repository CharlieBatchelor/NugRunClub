# =====================================================
# Plots the last X months total distances ran, for each
# Nug of the NugRunClub.
# =====================================================
import pandas as pd
...
# Make a list of months that we can iterate through
...
# Set up figure space
fig = plt.subplot(111)
title = "Monthly Total Distances - Past " + str(numMonths) + " Months"
...
# This part does the heavy lifting, loops through every Nug, all past 12 months, and every activity
for f, file in enumerate(file_list):
    ...
    # Plot the Nugs efforts for the past X months as a line thing
